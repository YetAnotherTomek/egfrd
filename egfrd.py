            ...
            #     (but not necessarily on the same structure!)
                ...
                for _ in range(self.dissociation_retry_moves):
                    ...
                    if isinstance(reactant_structure, PlanarSurface):
                        ...
                        if newpos1_is_out > 0 and newpos2_is_out > 0:
                            log.warning('Single reaction on adjacent planes: Both particles are outside of reactant_structure: reactant_pos=%s, iv=%s, newpos1=%s, newpos2=%s' % (reactant_pos, iv, newpos1, newpos2) )
